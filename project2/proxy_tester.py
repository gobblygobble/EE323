...
# 
pub_urls = ['http://www.mit.edu/', 'HTTP://www.ee.kaist.ac.kr',
            'http://wWW.kaist.edu/html/en/edu/edu_030104.html',
            'http://www.kist.re.kr/kist_web/resource/image/common/footer_logo.png'
            ]
